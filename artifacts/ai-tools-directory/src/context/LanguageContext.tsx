...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.blog': 'Blog',
    'blog.title': 'Blog',
    'blog.subtitle': 'Tips, trends and insights about AI tools.',
    'blog.readMore': 'Read article',
    'blog.back': 'Back to Blog',
    'blog.exploreTools': 'Explore Tools',
  ...
  es: {
    ...
    'nav.blog': 'Blog',
    'blog.title': 'Blog',
    'blog.subtitle': 'Consejos, tendencias y novedades sobre herramientas de IA.',
    'blog.readMore': 'Leer artículo',
    'blog.back': 'Volver al Blog',
    'blog.exploreTools': 'Explorar Herramientas',
