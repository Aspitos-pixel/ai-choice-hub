...
export const TOOLS: Tool[] = [
  ...
  {
    id: 'claude', name: 'Claude', url: 'https://claude.ai/', emoji: '🧠',
    categoryId: 'writing', categoryColor: COLORS.writing,
    description: {
  ...
  {
    id: 'copilot', name: 'GitHub Copilot', url: 'https://github.com/features/copilot', emoji: '👾',
  ...
  {
    id: 'cursor', name: 'Cursor', url: 'https://cursor.sh/', emoji: '⌨️',
    categoryId: 'coding', categoryColor: COLORS.coding,
    description: {
  ...
  {
    id: 'midjourney', name: 'Midjourney', url: 'https://www.midjourney.com/', emoji: '🎨',
  ...
  {
    id: 'dalle', name: 'DALL-E 3', url: 'https://openai.com/dall-e-3', emoji: '🖼️',
    categoryId: 'images', categoryColor: COLORS.images,
    description: {
  ...
  {
    id: 'firefly', name: 'Adobe Firefly', url: 'https://firefly.adobe.com/', emoji: '🔥',
    categoryId: 'images', categoryColor: COLORS.images,
    description: {
  ...
  {
    id: 'synthesia', name: 'Synthesia', url: 'https://www.synthesia.io/', emoji: '🎬',
  ...
  {
    id: 'runway', name: 'Runway', url: 'https://runwayml.com/', emoji: '🎞️',
    categoryId: 'video', categoryColor: COLORS.video,
    description: {
  ...
  {
    id: 'canva', name: 'Canva Magic Studio', url: 'https://www.canva.com/magic/', emoji: '🎭',
  ...
  {
    id: 'figma-ai', name: 'Figma AI', url: 'https://www.figma.com/ai/', emoji: '🖌️',
    categoryId: 'design', categoryColor: COLORS.design,
    description: {
  ...
  {
    id: 'elevenlabs', name: 'ElevenLabs', url: 'https://elevenlabs.io/', emoji: '🎙️',
  ...
  {
    id: 'murf', name: 'Murf AI', url: 'https://murf.ai/', emoji: '🔊',
    categoryId: 'voice', categoryColor: COLORS.voice,
    description: {
  ...
  {
    id: 'zapier', name: 'Zapier AI', url: 'https://zapier.com/ai', emoji: '⚡',
  ...
  {
    id: 'perplexity', name: 'Perplexity', url: 'https://www.perplexity.ai/', emoji: '🔍',
    categoryId: 'research', categoryColor: COLORS.research,
    description: {
  ...
  {
    id: 'jasper', name: 'Jasper', url: 'https://www.jasper.ai/', emoji: '✍️',
    categoryId: 'writing', categoryColor: COLORS.writing,
    description: {
  ...
  {
    id: 'grammarly', name: 'Grammarly AI', url: 'https://www.grammarly.com/', emoji: '📝',
    categoryId: 'writing', categoryColor: COLORS.writing,
    description: {
